...
def main(argv) -> int:
    ...
    # the second half of this line used to describe how the document was assembled ("only the
    # items graded core, every number read from tables/ at render time …"); dropped 2026-09-23
    # on the author's review — the brief is read by his advisors, and its own construction is
    ...
    generated = (
        ...
        f"LABELLING_ANALYSIS (notebook 04; PatSeer snapshot {values['snapshot']}) · Companion "
        f"to LABELLING_ANALYSIS.pdf, in the same folder.")
