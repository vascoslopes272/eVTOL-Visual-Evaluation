...
function decide(r,c,v){const o=document.getElementById('other');
 DEC[r.key]={choice:c,other:c==='other'?o.value:'',visible:c==='confirm'?'yes':(v||''),comment:document.getElementById('cmt').value,at:new Date().toISOString().slice(0,16),ts:Date.now(),n:nextN()};save();next()}
