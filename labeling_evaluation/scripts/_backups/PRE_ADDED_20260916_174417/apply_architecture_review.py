...
# aircraft the annotator removed or merged in the wizard after the freeze (user 2026-09-16):
# DROPPED rows leave the ground truth; RENAMED rows keep their decision under the wizard's current id
DROPPED = {"US2023257132A1_arch2": "merged into one aircraft in the wizard 2026-09-16"}
RENAMED = {"US2023257132A1_arch1": "US2023257132A1"}
...
vdf["variant_id"] = vdf["variant_id"].replace(RENAMED)
