...
def build_all(ds: Dataset, facts: Optional[Dict] = None,
    ...
    tables: Dict[str, pd.DataFrame] = {
        ...
        # rules of 2026-09-19: propulsion with its bases (rules 1, 3), the rule-4 sensitivity
        "a2_d3_propulsion": _dict_table(a2.d3_propulsor_units(ds)),
        **{f"a3_boom_wing_{k}": t for k, t in a3.boom_wing_sensitivity(ds).items()},
