...
NODES: List[Dict] = [
    ...
    dict(id="new", title="New questions these measures raise",
         text="Six questions the corpus raises and does not answer."),
    dict(id="new.1", title="Why does ducting come back at nine rotors and more?",
         tables=["la_duct_units"]),
...
NO_KEEP = tuple(n["id"] for n in NODES if n.get("figures") or n.get("tables"))
...
TEXTS: Dict[str, str] = {
    ...
    "new.1":
        ...
        "held fixed. The measure is panel (iii) of {sm_here_atlas_units}, and the bands "
        "themselves are the table below.\n\n"
    ...
    "new.2":
        ...
        "at all. It is condition 3 of {sm_here_la_dd_result}, and the two conditions that do not "
        "fire are drawn in {sm_here_dominant_design}.\n\n"
    ...
    "new.3":
        ...
        "class puts {sm_cvt_own_2023} of its own aircraft in that one window. The archetype is a "
        "cell of {sm_here_zones} and a row of `tables/la_zones.csv`.\n\n"
    ...
    "new.4":
        ...
        "Wing, against {sm_tw_air_2023} of that window's aircraft. The class shares behind it "
        "are drawn in {sm_here_atlas_arch_time}.\n\n"
    ...
    "new.5":
        ...
        "between them. The measure is {sm_here_a2_d15_trl_by_class}.\n\n"
