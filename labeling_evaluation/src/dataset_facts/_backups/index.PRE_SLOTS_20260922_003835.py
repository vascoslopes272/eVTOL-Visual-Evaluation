...
TABLE_CAPTIONS: Dict[str, str] = {
    ...
    "a2_d2_label_set": "The label set: questions, the export columns they fill, and the questions answered per aircraft",
    "a2_d2_questions_by_card": "Questions per card and kind (Figure 3.3b), and the export columns they fill",
...
FIGURE_CAPTIONS: Dict[str, str] = {
    ...
    "codebook_dimensions": "every dimension of the label cards G1 to M3; a tick box is a flag, # a number, \"if\" a question asked only when its condition holds, ×n a card repeated per part, pink an escape",
    ...
    "slots_histogram": "questions answered per unique aircraft",
...
FIG_WIDTH: Dict[str, str] = {
    ...
    "aircraft_spans_timeline": "78%", "window_shares_two_counts": "98%", "proximity_heatmap": "76%",
}
...
NODES: List[Dict] = [
    ...
    dict(id="3.3", title="Design space analysis", level="unique aircraft, G1 to M3",
         ...
         code=[]),
    dict(id="3.3.1", title="Questions answered per aircraft",
         text=("The questions are the ones Figure 3.3b draws: {questions} on the four cards G1 to "
               ...
               "left out. Sparsity is structural, a question is blank when the part does not "
               "exist, so an aircraft answers a median of {median_q} of the {questions} questions "
    ...
    dict(id="3.3.2", title="Missingness",
         text=("A blank is a labelling gap only where the parent field says the part exists. On "
               ...
               "Figure 3.3.2 asks each question only of the aircraft that have the part: a wing "
               "question of the winged aircraft, a boom question of the aircraft with booms. "
               "Divided by every aircraft instead, a boom question would look answered on fewer than "
    ...
    dict(id="5.3", title="The archetype and the distance",
         text=("The same aircraft is represented two ways, because the measures need different "
               ...
               "{q_M3} questions, repeated per host and propulsor type; card G1 (architecture) "
