...
QUESTION: Dict[str, str] = {
    ...
    "region_grid_b": "Q5 where — only the filer-type panel; powertrain and ducting say nothing",
    ...
    "atlas_units": "Q1 what is designed — direct (no standard number of propulsors)",
