...
CLASS_CONFIG_RULES: Dict[str, Tuple[str, List[str]]] = {
    "SLC": ("lift units: fixed / retract or fold · ducted or open · propulsive-unit band",
            ["lift kinematics", "duct", "band"]),
    "TR": ("tilting types: 1 / 2+ · ducted or open · propulsive-unit band",
           ["tilting types", "duct", "band"]),
    "CVT": ("tilting types × fixed types · propulsive-unit band",
            ["tilt mix", "band"]),
    "TW": ("wings: 1 / 2+ · ducted or open · propulsive-unit band",
           ["wings", "duct", "band"]),
    "MR": ("booms or no booms · ducted or open · propulsive-unit band",
           ["booms", "duct", "band"]),
}
