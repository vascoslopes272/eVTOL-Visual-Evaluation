...
_item("filings_per_year", [PS, HL, B64],
      ...
      "(i) bars: unique aircraft per priority year; line: the acquired patents. (ii) the same "
      "patent line of (i) drawn beside three wider counts of the same nine offices and the same "
      "priority year — every aeronautics patent (CPC B64), every CPC section-B patent (operations "
      "and transport), every patent — on a log axis, so that equal vertical gaps are equal ratios. "
      "Read a year as counts: in 2018 the corpus has 193 patents and the offices have about 12 800 "
      "B64 patents, so eVTOL is 15 of every 1 000 aeronautics patents that year. If the eVTOL line "
      "rises and the B64 line does not, the sector grew; if both rise together, aviation patenting "
      "at large grew. Complete years only. Source of the three baselines: WIPO PATENTSCOPE, counted "
      "by priority year at the corpus's nine offices; CPC B64* includes B64U, the UAV class created "
      "in 2022.",
