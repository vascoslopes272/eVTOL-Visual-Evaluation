...
QUESTION: Dict[str, str] = {
    ...
    "la_transitions": "Q4 who designs it — direct, but 28 of 50 cells hold 1-2 pairs",
    ...
    "la_ari_correlation": "none — 60 tests on 9-18 firms, 0 survive the correction",
...
GRADE: Dict[str, str] = {
    ...
    "filers_over_time": "weak, low representativeness (8 and 9 entering firms in the first two windows)",
    "la_filers_by_window": "core",
    "la_cohorts": "weak, low representativeness (8 and 9 entering firms in the first two windows)",
    "la_cohort_mix": "weak, low representativeness (8 and 9 entrants in the first two windows)",
    "atlas_filers": "core",
    ...
    "transitions": "weak, low representativeness (28 of 50 cells hold 1-2 pairs)",
    "la_transitions": "weak, low representativeness (30 pairs spread over 28 cells; only the diagonal reads)",
    "ip_strategy": "core",
    "la_ip_strategy": "core",
    ...
    "ari_clock": "core",
    "la_ari_firms": "core",
    "la_ari_correlation": "weak, low representativeness (28 of the 60 rows rest on 9 firms)",
    "la_ari_gap": "core",
    "la_ari_timeline": "core",
    "la_ari_clock_region": "weak, low representativeness (4 of 9 rows rest on one firm)",
    ...
    "country_class": "weak, low representativeness (5 of 8 countries hold under 25 aircraft)",
    "la_country_class": "weak, low representativeness (5 of 8 countries hold under 25 aircraft)",
