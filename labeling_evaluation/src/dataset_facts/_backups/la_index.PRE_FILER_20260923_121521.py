...
FIGURE_PANELS: Dict[str, List] = {
    ...
    # 2026-09-23: ducted unit and powertrain dropped, so 4.3.2b is filer type over the share row.
    # The share-of-the-window row is deliberately kept although 4.3.2a already carries it: the
    ...
    # (iii) added 2026-09-23: ducting has no regional or period signal, so it left Figure 4.3.2b
...
PROVENANCE: Dict[str, Dict[str, str]] = {
    ...
    "region_grid_b": dict(
        ...
        transform="shares as in Figure 4.3.2a, with the same n < 10 guard and the same absence of any "
                  ...
                  "carries them no longer. Powertrain went to 5.1: electric is this corpus's "
                  ...
                  "about the patent text and it is made where it belongs. Ducting went to 5.2 (iii): "
                  ...
                  "rotor count instead. Filer type comes from company_canonical (grouper.py: first "
    ...
    "atlas_units": dict(
        ...
        base="(i) each class's own aircraft; (ii) only those where the feature can be read, printed "
             ...
             "have no duct answer and form no band",
        transform="(i) one dot per aircraft, the bar spanning the middle half of the class (25th to "
                  ...
                  "can be read straight against 4.1.3 and 4.3.3. A band resting on fewer than 20 "
...
TAKEAWAY_NUMBERS: Dict[str, Dict] = {
    ...
    # Figure 5.2 (iii), ducting against rotor count. Every share is a share of AIRCRAFT; the class
...
TAKEAWAY: Dict[str, str] = {
    ...
    "region_grid_b": (
        ...
        "made in 5.1. Ducting genuinely does not vary by region or over time, but it varies "
        "strongly with the number of propulsive units, which is drawn in Figure 5.2 (iii). Read "
        "this panel for who files, not for what they build."),
    "specialisation": (
...
QUESTION: Dict[str, str] = {
    ...
    "region_grid_b": "Q4 who designs it — direct, by region (powertrain and ducting left; 5.1, 5.2)",
    ...
    # ================================================================ 5
    "atlas_powertrain": "Q1 what is designed — restates the electric gate; 4.1.5 (v) has it per window",
